...
const EintrachtFrankfurtVfLWolfsburg290924 = () => {
  ...
  return (
    <TeamColorProvider homeTeamColor={homeTeamColor} awayTeamColor={awayTeamColor} homeTeamName={homeTeam} awayTeamName={awayTeam}>
        <div
        style={{
            display: 'flex',
            padding: '64px 0px',
            ...
            <EventCard minute={90} extra_time={1} vorname='Stina' nachname='Johannes' text='Gelbe Karte für Stina Johannes wegen Zeitspiels.' card_type='Gelb' />
            ...
            <EventCard minute={89} vorname='Marina' nachname='Hegering' text='Gelbe Karte für Hegering nach einem Zweikampf mit Chiba.' card_type='Gelbe' />
            <Comment minute={87} text='Das Topspiel des 4. Spieltags wird übrigens von 4850 Fans im Stadion verfolgt.' />
            <EventSubstitution minute={86} player_in_vorname='Nina' player_in_nachname='Lührßen' player_out_vorname='Pia-Sophie' player_out_nachname='Wolter' />
            <EventSubstitution minute={86} player_in_vorname='Lara' player_in_nachname='Prasnikar' player_out_vorname='Nicole' player_out_nachname='Anyomi' />
            <EventSubstitution minute={86} player_in_vorname='Carlotta' player_in_nachname='Wamser' player_out_vorname='Laura' player_out_nachname='Freigang' />
            ...
            <EventSubstitution minute={76} player_in_vorname='Nuria' player_in_nachname='Rabano' player_out_vorname='Sarai' player_out_nachname='Linder' />
            <EventSubstitution minute={76} player_in_vorname='Chantal' player_in_nachname='Hagel' player_out_vorname='Lynn' player_out_nachname='Wilms' />
            <EventSubstitution minute={76} player_in_vorname='Rebecka' player_in_nachname='Blomqvist' player_out_vorname='Jule' player_out_nachname='Brand' />
            ...
            <EventSubstitution minute={73} text='Chiba muss für Senß kommen, die nach einem Zweikampf direkt signalisierte, dass sie nicht mehr weitermachen kann.' player_in_vorname='Remina' player_in_nachname='Chiba' player_out_vorname='Elisa' player_out_nachname='Senß' />
            ...
            <EventSubstitution minute={63} player_in_vorname='Sveindis' player_in_nachname='Jonsdottir' player_out_vorname='Lineth' player_out_nachname='Beerensteyn' />
            <EventSubstitution minute={63} player_in_vorname='Vivien' player_in_nachname='Endemann' player_out_vorname='Lena' player_out_nachname='Lattwein'/>
            <EventCard minute={61} vorname='Barbara' nachname='Dunst' card_type='Gelb' />
            ...
            <EventSubstitution minute={58} text='Die schon früh vorbelastete und zweikampfstarke Kleinherne verlässt den Platz für Aehling.' player_in_vorname='Anna' player_in_nachname='Aehling' player_out_vorname='Sophia' player_out_nachname='Kleinherne' /> 
            ...
            <EventCard minute={55} vorname='Lena' nachname='Lattwein' text='Gelbe Karte für Lattwein nach Foul an Reuteler' card_type='Gelb' />
            ...
            <EventCard minute={17} vorname='Pia-Sophie' nachname='Wolter' text='Jetzt hat auch die zweite der vier Verteidigerinnen eine frühe Verwarnung bekommen. Wolter verliert den Ball in der eigenen Hälfte an Popp und steigt ihr danach in die Hacke.' card_type='Gelb' />
            ...
            <EventCard minute={7} vorname='Sophia' nachname='Kleinherne' text='Kleinherne hält Beerensteyn am Arm und verhindert somit in der eigenen Hälfte eine mögliche Konterchance.' card_type='Gelb' />
