          ...
          <div className='container-web'> 
              ...
              {activeTab === "Ticker" && (
                  <>
                      ...
                      <EventSubstitution minute={82} team="Away" player_in_vorname="Niklas" player_in_nachname="Süle" player_out_vorname="Yan" player_out_nachname="Couto" />
                      ...
                      <EventSubstitution minute={66} text="Gittens muss humpelnd den Platz verlassen und wird durch Duranville ersetzt." player_in_vorname="Julien" player_in_nachname="Duranille" player_out_vorname="Jamie" player_out_nachname="Gittens" team="Home" />
